...
cargoAccepts = {
	...
	factory_bravo =  allExcept(cargoSpawns, 'Factory_Bravo'),
...
bravo = ZoneCommander:new({zone='Bravo', side=0, level=3, upgrades=farp, crates=cargoAccepts.bravo, flavorText=flavor.bravo})
...
krymsk = ZoneCommander:new({zone='Krymsk', side=0, level=5, upgrades=airfield, crates=cargoAccepts.krymsk, flavorText=flavor.krymsk})
...
factory_bravo = ZoneCommander:new({zone='Factory Bravo', side=1, level=1, upgrades=regularzone, crates=cargoAccepts.factory_bravo, flavorText=flavor.factory, income=2})
...
maykop = ZoneCommander:new({zone='Maykop', side=1, level=5, upgrades=airfield, crates=cargoAccepts.krymsk, flavorText=flavor.krymsk})
...
factory_bravo:addCriticalObject('FactoryBuilding1')
factory_bravo:addCriticalObject('FactoryBuilding2')
...
dispatch = {
	...
	factory_bravo={
		...
		GroupCommander:new({name='factory-echo-supply', mission='supply', targetzone='Echo', type='surface'}),
		GroupCommander:new({name='factory-foxtrot-supply', mission='supply', targetzone='Foxtrot', type='surface'}),
		GroupCommander:new({name='factory-factory-supply', mission='supply', targetzone='Factory', type='surface'})
	},
	echo={
	...
	maykop = {
		GroupCommander:new({name='mayk1', mission='supply', targetzone='Bravo'}),
		GroupCommander:new({name='mayk2', mission='attack', targetzone='Bravo'}),
		GroupCommander:new({name='mayk3', mission='patrol', targetzone='Bravo'}),
		GroupCommander:new({name='mayk4', mission='patrol', targetzone='Krymsk'}),
		GroupCommander:new({name='mayk5', mission='supply', targetzone='Radio Tower'}),
		GroupCommander:new({name='mayk6', mission='attack', targetzone='Radio Tower'}),
		GroupCommander:new({name='mayk7', mission='patrol', targetzone='Radio Tower'}),
		GroupCommander:new({name='mayk8', mission='patrol', targetzone='Bravo'}),
		GroupCommander:new({name='mayk9', mission='patrol', targetzone='Krymsk'}),
		GroupCommander:new({name='mayk10', mission='supply', targetzone='Bravo'}),
		GroupCommander:new({name='mayk11', mission='supply', targetzone='Radio Tower'}),
		GroupCommander:new({name='mayk12', mission='supply', targetzone='Delta'}),
		GroupCommander:new({name='mayk13', mission='attack', targetzone='Delta'}),
		GroupCommander:new({name='mayk14', mission='supply', targetzone='Factory'}),
		GroupCommander:new({name='mayk15', mission='attack', targetzone='Factory'}),
		GroupCommander:new({name='mayk16', mission='supply', targetzone='Delta'}),
		GroupCommander:new({name='mayk17', mission='supply', targetzone='Factory'}),
		GroupCommander:new({name='mayk18', mission='supply', targetzone='SAM Site'}),
		GroupCommander:new({name='mayk19', mission='supply', targetzone='SAM Site'}),
		GroupCommander:new({name='mayk20', mission='attack', targetzone='SAM Site'}),
		GroupCommander:new({name='mayk21', mission='patrol', targetzone='Delta'}),
		GroupCommander:new({name='mayk22', mission='supply', targetzone='Oil Fields'}),
		GroupCommander:new({name='mayk23', mission='supply', targetzone='Oil Fields'}),
		GroupCommander:new({name='mayk24', mission='attack', targetzone='Oil Fields'}),
		GroupCommander:new({name='mayk25', mission='attack', targetzone='Bravo', type='surface'})
	},
	oilfields={
...
factory_bravo:addGroups(dispatch.factory_bravo)
...
bc:addConnection("Maykop","SAM Site")
bc:addConnection("Maykop","Oil Fields")
bc:addConnection("Maykop","Radio Tower")
bc:addConnection("Maykop","Factory")
bc:addConnection("Maykop","Delta")
bc:addConnection("Maykop","Krymsk")
